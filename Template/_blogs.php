                ...
                <div class="owl-carousel owl-theme">
                  <div class="item">
                    <div class="card border-0 font-rale mr-5" style="width:18rem;">
                      <h5 class="cart-title font-size-16">Upcoming Mobile</h5>
                      <img src="assets/blog/blog1.jpg" alt="cart image" class="card-img-top">
                      <p class="cart-text font-size-14 text-black-50 py-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem quam est cumque eligendi blanditiis mollitia dolorum nobis dignissimos dolorem quidem!</p>
